...
public class CafeKiosk {
	...
	public Order createOrder() {
		...
		LocalTime currentDateTime = currentLocalDateTime.toLocalTime();
		...
		return Order.of(currentLocalDateTime, beverages);
	}

	public Order createOrder(LocalDateTime currentLocalDateTime) {
		LocalTime currentDateTime = currentLocalDateTime.toLocalTime();
		if (currentDateTime.isBefore(SHOP_OPEN_TIME) || currentDateTime.isAfter(SHOP_CLOSE_TIME)) {
			throw new IllegalArgumentException("주문 시간이 아닙니다. 관리자에게 문의해주세요");
		}
